...
def main():
    ...
    input(f'You are about to delete {len(shitty_scrobbles)} precious scrobble!!!!!!!!!!\nPress enter to continue..........................')
